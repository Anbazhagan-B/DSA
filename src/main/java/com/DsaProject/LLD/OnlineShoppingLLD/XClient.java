package com.DsaProject.LLD.OnlineShoppingLLD;

import com.DsaProject.LLD.OnlineShoppingLLD.decorator.GiftWrapDecorator;
import com.DsaProject.LLD.OnlineShoppingLLD.enums.ProductCategory;
import com.DsaProject.LLD.OnlineShoppingLLD.models.*;
import com.DsaProject.LLD.OnlineShoppingLLD.strategy.CreditCardPaymentStrategy;
import com.DsaProject.LLD.OnlineShoppingLLD.strategy.UPIPaymentStrategy;

public class XClient {
    public static void main(String[] args) {
        // --- System Setup (Singleton and Services) ---
        OnlineShoppingService system = OnlineShoppingService.getInstance();
