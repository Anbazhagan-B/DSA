...
import com.DsaProject.LLD.MusicStreamingLLD.command.NextTrackCommand;
import com.DsaProject.LLD.MusicStreamingLLD.command.*;
...
public class XClient {
    public static void main(String[] args) throws InterruptedException {
        ...
        List<Song> recommendations = system.getSongRecommendation();
