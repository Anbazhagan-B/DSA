...
import com.DsaProject.LLD.SnakeAndLadderLLD.enums.GameStatus;
import com.DsaProject.LLD.SnakeAndLadderLLD.models.Board;
import com.DsaProject.LLD.SnakeAndLadderLLD.models.BoardEntity;
import com.DsaProject.LLD.SnakeAndLadderLLD.models.Dice;
import com.DsaProject.LLD.SnakeAndLadderLLD.models.Player;
...
public class Game {
    ...
    public static class Builder
    {
        ...
        {
            board = new Board(boardSize, boardEntities);
            return this;
        }
        ...
        public Game build()
        {
            if(this.players == null || this.dice == null || this.board == null)
            {
