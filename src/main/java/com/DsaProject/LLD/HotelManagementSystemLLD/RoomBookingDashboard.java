...
import com.DsaProject.LLD.HotelManagementSystemLLD.payment.CreditCardPayment;
import com.DsaProject.LLD.HotelManagementSystemLLD.payment.Payment;

import java.time.LocalDate;

public class RoomBookingDashboard {
    public static void main(String[] args)
    {
        ...
        // Create rooms
        Room room1 = new Room("R001", RoomType.SINGLE, 100.0, RoomStatus.AVAILABLE);
        Room room2 = new Room("R002", RoomType.DOUBLE, 200.0, RoomStatus.AVAILABLE);
